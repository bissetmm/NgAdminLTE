...
export class Dashbord2Component implements OnInit {
  ...
  @ViewChild('pie')
  public pie: AccumulationChart | undefined
  @ViewChild('piechart') public piechart: ChartComponent | undefined
      ...
      markerSettings: [
        {
          ...
          shape: 'Image',
          imageUrl:
            'https://ej2.syncfusion.com/demos/src/maps/images/ballon.png',
          height: 20,
          width: 20,
          offset: {
            y: -10,
